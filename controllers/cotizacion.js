...
module.exports = async (req, res) =>{
  ...
  for (let a = 1; a < req.body.precio.length; a++) {
    const precioFormateado = formatNumberWithCommas(req.body.precio[a]);
    const productoString = `${a}.- Nombre: ${req.body.nombre[a]} Precio: ${precioFormateado} Código: ${req.body.codigo[a]} Cantidad: ${req.body.amount[a]}`;
...
*Precio Total:* ${suma.toLocaleString()}
