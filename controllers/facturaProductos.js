...

		{
			...
			table: {
				...
				body: [
                    ...
                    [{fontSize:11,text:" "}, " "," ","Indirectos y Honorarios", PorcentajeMaterial+"%", ManoObMaterial2R],
                    ...
                    [{fontSize:11,text:" "}, " "," ","Indirectos y Honorarios", PorcentajePintura+"%", ManoObPintura2R],
                    ...
                    [{fontSize:11,text:" "}, " "," ","Indirectos y Honorarios", PorcentajeInstalacion+"%",ManoObInstalacion2R],
