...
module.exports = async (req, res) => {
    const BuscarPrimero = await Product.find({
    ...
    const PdfDescargar = await Compra.find({
                ...
                table: {
                    ...
                    body: [
                        ...
                        [
                            ...
                            productosMaterialesCodigo,
                            ProductosMaterialesUnidad,
                            PreciosMateriales,
                            productosMaterialesCantidad,
                            ImporteMateriales,
                        ],
                        [
                            { fontSize: 11, text: ' ' },
                        ...
                        [
                            { fontSize: 11, text: productosPinturaDescripcion },
                            productosPinturaCodigo,
                            ProductosPinturasUnidad,
                            PreciosPintura,
                            productosPinturaCantidad,
                            ImportePinturas,
                        ],
                        [
                            { fontSize: 11, text: ' ' },
                        ...
                        [
                            ...
                            productosInstalacionCodigo,
                            ProductosInstalacionUnidad,
                            PreciosInstalaciones,
                            productosInstalacionCantidad,
                            ImporteInstalaciones,
                        ],
                        [
                            { fontSize: 11, text: ' ' },
                            ' ',
