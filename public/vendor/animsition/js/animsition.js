...
(function (factory) {
    ...
    var __ = {
        ...
        removeLoading: function () {
            ...
            const $loading = $(options.loadingParentElement).children(
                '.' + options.loadingClass
            );
        ...
        in: function () {
            ...
            const inDuration = __.animationCheck.call(
                _this,
                thisInDuration,
                false,
                true
            );
            const inClass = __.animationCheck.call(
                _this,
                thisInClass,
                true,
                true
        ...
        out: function ($self, url) {
            ...
            const outClass = __.animationCheck.call(
                _this,
                isOutClass,
                true,
                false
            );
            const outDuration = __.animationCheck.call(
                _this,
                isOutDuration,
                false,
                false
