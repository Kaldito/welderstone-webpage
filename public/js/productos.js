...
const modalMaterialesFamilias = document.querySelectorAll(
    '.modal-materiales-familias'
);
const modalMaterialesSubfamilias = document.querySelectorAll(
    '.modal-materiales-subfamilias'
);

const modalPinturas = document.querySelectorAll('.modal-pintura');
const modalPinturaFamilias = document.querySelectorAll(
    '.modal-pintura-familias'
);
const modalPinturaSubfamilias = document.querySelectorAll(
    '.modal-pintura-subfamilias'
);

const modalInstalacion = document.querySelectorAll('.modal-instalacion');
const modalInstalacionFamilias = document.querySelectorAll(
    '.modal-instalacion-familias'
);
const modalInstalacionSubfamilias = document.querySelectorAll(
...
function filtrar(barraBusqueda, filterArray, filter) {
    ...
    for (const material of filterArray) {
        if (filter == 'Descripcion') {
            ...
            const nombre = material.value.toLowerCase();
...
materialBusqueda.addEventListener('input', function () {
    if (materialesFiltro.value == 'Descripcion') {
        ...
        filtrar(
            materialBusqueda,
            modalMaterialesFamilias,
            materialesFiltro.value
        );
    } else {
        filtrar(
            materialBusqueda,
            modalMaterialesSubfamilias,
            materialesFiltro.value
        );
    }
});
...
instalacionBusqueda.addEventListener('input', function () {
    if (instalacionFiltro.value == 'Descripcion') {
        ...
        filtrar(
            instalacionBusqueda,
            modalInstalacionFamilias,
            instalacionFiltro.value
        );
    } else {
        filtrar(
            instalacionBusqueda,
            modalInstalacionSubfamilias,
            instalacionFiltro.value
        );
    }
});
